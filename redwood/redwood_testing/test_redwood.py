...
class RedwoodTester(unittest.TestCase):
    ...
    def test_ignore_det(self):
        assert(mod.ignore_det(['/home/sherlock/test',
                               '/home/sherlock/projects',
                               '/home/sherlock/Downloads'],
                               '/home/sherlock') == True)
        assert(mod.ignore_det(['/home/sherlock/test',
                               '/home/sherlock/projects',
                               '/home/sherlock/Downloads'],
                               '/home/sherlock/Downloads') == False)
        assert(mod.ignore_det(['/home/sherlock/test',
                               '/home/sherlock/projects',
                               '/home/sherlock/Downloads'],
                               '/home/sherlock/projects') == False)
        assert(mod.ignore_det(['/home/sherlock/test',
                               '/home/sherlock/projects',
                               '/home/sherlock/Downloads'],
                               '/home/sherlock/test') == False)
        assert(mod.ignore_det(['/home/sherlock/test',
                               '/home/sherlock/projects',
                               '/home/sherlock/Downloads'],
                               '/home/sherlock/perl') == True)
